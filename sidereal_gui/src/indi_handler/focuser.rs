...
///
/// This module contains functions for interacting with INDI focuser devices.
/// Add focuser-specific telemetry and command functions here as needed.
///
/// **Device handling pattern:**
/// - All control functions should return `SiderealResult` and handle missing devices gracefully
/// - Error messages should be user-friendly: "Focuser device not available. Please ensure the device is connected to the INDI server."
...
///
/// Get the active focuser device if available
#[allow(dead_code)]
pub fn get_focuser() -> Option<ActiveDevice> {
